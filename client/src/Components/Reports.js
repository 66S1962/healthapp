...
import './Reports.css';
import { FaUserMd, FaRegistered, FaRegListAlt, FaCalendarAlt, FaStethoscope, FaLaptopMedical, FaCreditCard, FaSignInAlt, FaSignOutAlt, FaWhatsapp, FaTwitter, FaInstagram, FaFacebook, FaPills } from "react-icons/fa";
...
const Reports = () => {
  ...
  <li><Link to="/logout"><span className="icon"><FaSignOutAlt /></span> Logout</Link></li>
      ...
      <div className="print-button-container">
        <button onClick={printPage} className="print-page-btn">
          Print Page
        </button>
      </div>
            ...
            <li key={report._id} className="report-card">
              ...
              <div className="actions">
                ...
                <button
                  ...
                  onClick={() => navigate(`/book-appointment/${report._id}`)}
                >
                  Book Appointment
                </button>
